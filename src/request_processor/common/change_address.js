...
function getFullAddress(muniCd, lv01Nm) {
    ...
    const cityName = getCitynameSync(muniCd); // The old code uses sync wait or promises, let's just make it async in caller if needed, or getCityname requires library api call.
...
//# sourceMappingURL=change_address.js.map